...
function AdminTable() {
  const rows = ADMIN_RESOURCES.modulos as Array<Record<string, string | number>>;
  const cols = rows.length ? Object.keys(rows[0]) : [];
  return (
    <AdminShell>
      <PageHeader crumbs={[{ label: "Admin", to: "/admin" }, { label: "Módulos" }]} eyebrow="Admin" title="Módulos" description="CRUD de módulos."

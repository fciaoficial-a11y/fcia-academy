...
function AdminTable() {
  const rows = ADMIN_RESOURCES.cursos as Array<Record<string, string | number>>;
  const cols = rows.length ? Object.keys(rows[0]) : [];
  return (
    <AdminShell>
      <PageHeader crumbs={[{ label: "Admin", to: "/admin" }, { label: "Cursos" }]} eyebrow="Admin" title="Cursos" description="CRUD de cursos."
